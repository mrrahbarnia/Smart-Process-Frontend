...
const BrandItem = (props: {brand: BrandType}) => {
    ...
    return (
        <Link href="#" className="relative border-2 rounded-md border-blue-300 bg-blue-50 hover:bg-blue-100 transition-colors duration-300 flex flex-col gap-2 h-auto p-2 w-full items-center">
