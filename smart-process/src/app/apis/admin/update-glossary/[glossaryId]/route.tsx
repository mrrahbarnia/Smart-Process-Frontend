...
const EXTERNAL_API = `${EXTERNAL_BASE_ENDPOINT}/admin/update-glossary`;

export const PUT = async (request: NextRequest, {params}: {params: {glossaryId: number}}) => {
    const glossaryId = params.glossaryId;
    const data = await request.json()

    try {
        const accessToken = await getToken();
        await axios.put(`${EXTERNAL_API}/${glossaryId}/`, data, {
            headers: {
