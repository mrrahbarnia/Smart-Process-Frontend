...
const EXTERNAL_API = `${EXTERNAL_BASE_ENDPOINT}/admin/delete-article-comment`;

export const DELETE = async (request: NextRequest, {params}: {params: {id: number}}) => {
    const articleCommentId = params.id;

    try {
        const accessToken = await getToken();
        await axios.delete(`${EXTERNAL_API}/${articleCommentId}/`, {
            headers: {
